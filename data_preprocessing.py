...
train_data_file = open('F:/WHJR Projects/pro119/pro119/Scripts/intents.json')
...
def preprocess_train_data():
    ...
    pickle.dump(stem_words, open('F:/WHJR Projects/pro119/pro119/Scripts/words.pkl','wb'))
    pickle.dump(tag_classes, open('F:/WHJR Projects/pro119/pro119/Scripts/classes.pkl','wb'))
